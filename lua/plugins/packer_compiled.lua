...
_G.packer_plugins = {
  ...
  ["nvim-treesitter"] = {
    after = { "nvim-treesitter-textobjects", "nvim-ts-context-commentstring", "nvim-ts-autotag", "nvim-treesitter-refactor", "playground" },
...
vim.cmd [[au CursorHold * ++once lua require("packer.load")({'nvim-treesitter', 'telescope.nvim', 'nvim-tree.lua'}, { event = "CursorHold *" }, _G.packer_plugins)]]
